[iotsolution-grpc-534a-3f10-grpc-] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [iotsolution-grpc-534a-3f10-grpc-] container is NOT running**.

.. tip::
   You must have your [iotsolution-grpc-534a-3f10-grpc-] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   http://localhost:49689/iot-failure-seneca.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
[iotsolution-grpc-534a-3f10-grpc-] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/iotsolution-grpc-534a-3f10-grpc-
...
.. important::
   solution_preprocessing_dag_grpc-iotsolution-grpc-534a-3f10
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=34971, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=35027, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=40309, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=34737, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=37371, HPDEHOST=127.0.1.1, HPDEPORT=37779, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=36175

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5756-iotsolution-grpc-534a-3f10-grpc-,solution_preprocessing_dag_grpc-iotsolution-grpc-534a-3f10, python-preprocess-9323-iotsolution-grpc-534a-3f10-grpc-,solution_preprocessing_dag_grpc-iotsolution-grpc-534a-3f10, python-preprocess2-4767-iotsolution-grpc-534a-3f10-grpc-,solution_preprocessing_dag_grpc-iotsolution-grpc-534a-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
